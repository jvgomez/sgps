...
public:
	...
	/**
	 * Method to obtain coodinates
	 * */
	void computeCoordinates();
	// This function works over one given day.
	/**
	 * Method to get coodinates of a day
	 * @param information of a day
	 * @return Coordinates
	 * */
	...
	/**
	 * Method to save real coodinates in a vector
	 * @param vector empty to save corrdinates
	 * @return the size of the vector
	 * */
	int getCoordinates (std::vector<Coordinates> &);
	
	/**
	 * Method to save SGPS coodinates in a vector
	 * @param vector empty to save corrdinates
	 * @return the size of the vector
	 * */	
	int getSGPSCoordinates (std::vector<Coordinates> &);
