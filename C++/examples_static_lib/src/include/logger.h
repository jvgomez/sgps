...
public:
	 ...
	 * */
	static void errorCoord (const Coordinates realCoord, const Coordinates sgpsCoord, const Coordinates errorDegree, const float errorKm1, const Coordinates errorKm2, const Coordinates errorPercent);
